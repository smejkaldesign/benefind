  ...
  return (
    <>
      ...
      <main className="relative flex min-h-dvh flex-col items-center justify-center overflow-hidden px-4 pt-20">
        ...
        <div className="relative z-10 flex w-full max-w-[534px] flex-col items-center rounded-xl border border-white/[0.05] bg-black/70 px-8 py-16 shadow-2xl shadow-black/50 backdrop-blur-sm sm:px-12 sm:py-20">
          {sent ? (
