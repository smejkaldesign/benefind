  ...
  checkEligibility(input: CompanyScreeningInput) {
    if (!input.exportsOrPlans) {
      return {
        ...
        confidence: "high",
        reason:
          "STEP grants are for companies that export or plan to export products/services.",
        nextSteps: [],
        whyYouQualify: [],
      };
    }
    ...
    if (!isSmallBusiness(input.employeeCount)) {
      return {
        ...
        confidence: "high",
        reason:
          "STEP is limited to small businesses (fewer than 500 employees).",
        nextSteps: [],
        whyYouQualify: [],
      };
    }
    ...
    return {
      ...
      confidence: "medium",
      reason:
        "You are a small business that exports or plans to export, making you eligible for STEP grants.",
