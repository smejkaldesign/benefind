...
const STATE_PROGRAMS: Record<
  string,
  { name: string; maxPerEmployee: number; maxPerCompany: number; url: string }
> = {
  MA: {
    name: "Workforce Training Fund Program",
    maxPerEmployee: 5000,
    maxPerCompany: 250000,
    url: "https://www.mass.gov/workforce-training-fund-program",
  },
  IN: {
    name: "Indiana Workforce Training Grants",
    maxPerEmployee: 5000,
    maxPerCompany: 50000,
    url: "https://www.in.gov/dwd/",
  },
  NY: {
    name: "Employee Training Incentive Program (ETIP)",
    maxPerEmployee: 10000,
    maxPerCompany: 100000,
    url: "https://esd.ny.gov/employee-training-incentive-program-etip",
  },
  TX: {
    name: "Skills Development Fund",
    maxPerEmployee: 3000,
    maxPerCompany: 500000,
    url: "https://www.twc.texas.gov/programs/skills-development-fund",
  },
  AR: {
    name: "Grow Our Own Grants",
    maxPerEmployee: 3000,
    maxPerCompany: 50000,
  ...
  FL: {
    ...
    maxPerEmployee: 3000,
    maxPerCompany: 250000,
    url: "https://floridajobs.org/office-directory/division-of-workforce-services/quick-response-training",
  },
};
  ...
  checkEligibility(input: CompanyScreeningInput) {
    if (!input.isHiring) {
      return {
        ...
        confidence: "medium",
        reason:
          "Workforce training grants are available even for training existing employees, but hiring companies get higher priority.",
    ...
    return {
      ...
      confidence: "medium",
      reason:
        "Nearly every state offers workforce training grants. Contact your state workforce agency for specific programs.",
      estimatedValue: "$5K-$50K",
      nextSteps: [
