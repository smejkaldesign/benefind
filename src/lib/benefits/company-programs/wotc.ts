...
export const wotc: CompanyProgram = {
  ...
  status: 'expired',
  applicationUrl: 'https://www.irs.gov/businesses/small-businesses-self-employed/work-opportunity-tax-credit',
  ...
  checkEligibility(input: CompanyScreeningInput) {
    ...
    return {
      ...
      matchScore: 65,
      confidence: 'medium',
      reason: 'You are actively hiring, which makes you eligible for WOTC if you hire from qualifying groups. Note: program expired Dec 2025, monitor for reauthorization.',
