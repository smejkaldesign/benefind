...
export const COMPANY_SCREENING_STEPS: ScreeningStep[] = [
  ...
  },
  {
    ...
    helpText:
      "Many programs are state-specific. We need this for accurate matching.",
    type: "state",
    required: true,
  },
  {
  ...
  },
  {
    ...
    helpText:
      "Some programs target startups, others require operational history.",
    type: "select",
    options: [
  ...
  },
  {
    ...
    helpText:
      "This helps us estimate program values. Your answer stays private.",
    type: "select",
    options: [
  ...
  },
  {
    ...
    helpText:
      "This includes software development, engineering, product design, process improvement, and scientific research.",
    type: "select",
    options: [
      { label: "Yes", value: "yes" },
      { label: "No", value: "no" },
  ...
  },
  {
    ...
    helpText:
      "Your best estimate is fine. This helps us calculate your R&D Tax Credit.",
    type: "select",
    options: [
  ...
  },
  {
    ...
    helpText:
      "Some federal programs provide contracting preferences. Select all that apply.",
    type: "multi-select",
    options: [
  ...
  },
  {
    ...
    helpText:
      "Rural = outside cities with 50,000+ population. USDA has grants specifically for rural businesses.",
    type: "select",
    options: [
      { label: "Yes", value: "yes" },
      { label: "No", value: "no" },
  ...
  },
  {
    id: "exportsOrPlans",
    question:
      "Do you export or plan to export products/services internationally?",
    type: "select",
    options: [
  ...
  },
  {
    ...
    helpText:
      "Several programs offer tax credits and training grants for employers who are hiring.",
    type: "select",
    options: [
  ...
  },
  {
    ...
    helpText:
      "Solar panels, EV fleet, energy-efficient buildings, renewable energy projects, etc.",
    type: "select",
    options: [
      { label: "Yes", value: "yes" },
      { label: "No", value: "no" },
...
const VALID_INDUSTRIES: CompanyScreeningInput["industry"][] = [
  "technology",
  "healthcare",
  "manufacturing",
  "agriculture",
...
const VALID_AGES: CompanyScreeningInput["companyAge"][] = [
  "<1",
  "1-5",
  "5-10",
  "10+",
];
const VALID_EMPLOYEE_RANGES: CompanyScreeningInput["employeeCount"][] = [
  "1-10",
  "11-50",
  "51-100",
  "101-500",
...
const VALID_REVENUE_RANGES: CompanyScreeningInput["annualRevenue"][] = [
  "<250k",
  "250k-1m",
  "1m-5m",
  "5m-25m",
...
const VALID_OWNERSHIP: CompanyScreeningInput["ownershipDemographics"][number][] =
  ["minority", "woman", "veteran", "none"];
...
export function answersToCompanyInput(
  ...
  const ownership = (answers.ownershipDemographics || "none")
    .split(",")
    .filter(
      (v): v is CompanyScreeningInput["ownershipDemographics"][number] =>
        VALID_OWNERSHIP.includes(
          v as CompanyScreeningInput["ownershipDemographics"][number],
        ) && v !== "none",
    );
  ...
  return {
    ...
    industry: VALID_INDUSTRIES.includes(
      rawIndustry as CompanyScreeningInput["industry"],
    )
      ? (rawIndustry as CompanyScreeningInput["industry"])
      : "other",
    companyAge: VALID_AGES.includes(
      rawAge as CompanyScreeningInput["companyAge"],
    )
      ? (rawAge as CompanyScreeningInput["companyAge"])
      : "1-5",
    employeeCount: VALID_EMPLOYEE_RANGES.includes(
      rawEmployees as CompanyScreeningInput["employeeCount"],
    )
      ? (rawEmployees as CompanyScreeningInput["employeeCount"])
      : "1-10",
    annualRevenue: VALID_REVENUE_RANGES.includes(
      rawRevenue as CompanyScreeningInput["annualRevenue"],
    )
      ? (rawRevenue as CompanyScreeningInput["annualRevenue"])
      : "<250k",
